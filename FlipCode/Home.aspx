...
<body style="background-color:#d4b4b4;">
       ...
       <li class="nav-item dropdown" >
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="Login.aspx">Login</a>
            <a  class="dropdown-item" href ="SignUp.aspx" >New User? Sign Up</a>
            <a class="dropdown-item" href="Login.aspx">My Profile</a>
            <a class="dropdown-item" href="Login.aspx">Orders</a>
...
<%--========================================================================================--%>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="C1.png" alt="First slide"  width="100px" height="400px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="C2.jpg" alt="Second slide" width="100px" height="400px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="C3.jpg" alt="Third slide" width="100px" height="400px">
    </div>
